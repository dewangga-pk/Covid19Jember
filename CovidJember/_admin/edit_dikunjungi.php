...
$id = $_GET['id'];
$identitas = mysqli_fetch_assoc(getData("SELECT * FROM visited WHERE id=$id"));
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-1 text-gray-800">Detail Informasi Dikunjungi</h1>
                <p class="mb-4"></p>
                            ...
                            <div class="card-header py-3">
                                <div class="row">
                                    ...
                                    <div class="col-sm-1 offset-7">
                                        <a href="detail_dikunjungi.php?id=<?= $id; ?>" class="btn btn-warning btn-circle"><i class="fas fa-backspace"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
