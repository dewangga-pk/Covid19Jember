...
$id = $_GET['id'];
$identitas = mysqli_fetch_assoc(getData("SELECT v.nama,d.name as kecamatan,v.alamat_lengkap FROM visited AS v JOIN districts AS d ON v.id_kecamatan=d.id  WHERE v.id=$id"));
?>
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>Admin - Detail Dikunjungi</title>
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <h1 class="h3 mb-1 text-gray-800">Detail Informasi yang dikunjungi</h1>
                <p class="mb-4"></p>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="card position-relative">
                            <div class="card-header py-3">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <h6 class="m-0 font-weight-bold text-primary">Dikunjungi</h6>
                                    </div>
                                    <div class="col-sm-1 offset-7">
                                        <a href="edit_dikunjungi.php?id=<?= $id; ?>" class="btn btn-info btn-circle btn-sm"><i class="fas fa-pen-square"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-1">:</div>
                                    <div class="col-sm-7"><?= $identitas['kecamatan'];?></div>
                                </div>
                                <div class="row">
